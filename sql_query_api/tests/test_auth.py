...
def test_principal_rejects_missing_identity_or_tenant_claims() -> None:
    ...
    assert build_principal_from_claims({"sub": "auth0|user-123", "email": "alice@example.com"}) is None
    assert build_principal_from_claims({"sub": "auth0|user-123", "org_id": "org-42"}) is None
